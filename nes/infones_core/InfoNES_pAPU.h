...
/* PSRAM-resident APU buffers (defined in InfoNES_pAPU.c). Declared here so
   nes_bridge_init() can explicitly zero them (the .psram_bss section is not
   guaranteed to be cleared by the startup on BL616). */
