...
/* RAM */
BYTE RAM[ RAM_SIZE ] NES_PSRAM_BSS;

/* SRAM */
BYTE SRAM[ SRAM_SIZE ] NES_PSRAM_BSS;
...
/* PPU RAM */
BYTE PPURAM[ PPURAM_SIZE ] NES_PSRAM_BSS;
...
WORD WorkFrameIdx;
#else
WORD WorkFrame[ NES_DISP_WIDTH * NES_DISP_HEIGHT ] NES_PSRAM_BSS;
#endif

/* Character Buffer */
BYTE ChrBuf[ 256 * 2 * 8 * 8 ] NES_PSRAM_BSS;
